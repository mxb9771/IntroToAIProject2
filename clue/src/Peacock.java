...
public class Peacock extends CluePlayer {  
    
    private int curr_row = 2;
    private int curr_column = 12;
    ...
    public void printCards() {
        System.out.print("Mrs Peacock's Cards: ");
    ...
    public void printNotes() {
        System.out.println("Mrs. Peacock's Detective Notes: ");
